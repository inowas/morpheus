      ...
      <div className={styles.footerTop}>
        <Container>
          <div className={styles.footerTop_row}>
            ...
            <div className={styles.footerTop_col}>
              <h3 className={styles.footerTop_title}>Supported by</h3>
              <a
            ...
            <div className={styles.footerTop_col}>
              <h3 className={styles.footerTop_title}>Developed by</h3>
              <a
      ...
      <div className={styles.footerBottom}>
        <Container>
          <div className={styles.footerWrapper}>
            ...
            <div className={styles.footerSearch}>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  <a
                    href="https://inowas.com/declaration-on-accessibility/"
                    rel="noreferrer"
                    target="_blank"
                  >
                    Accessibility
          ...
          <div className={styles.footerCopyrights}>
            Copyright © 2023 INOWAS | CC BY-SA 4.0
            <a
              target="_blank"
