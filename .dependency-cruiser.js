  ...
  forbidden: [
    {
      ...
      from: {
        ...
        pathNot: ["^src/app/modules/.+/incoming"],
      },
      to: {
        path: "^src/app/modules/",
        pathNot: ["^src/app/modules/$1/"],
      },
    },
    {
      ...
      to: {
        ...
        // other modules.
        pathNot: ["^src/app/modules/$1/", "^src/app/modules/.+/outgoing"],
      },
    },
        ...
        */
        theme: {
          ...
          dependencies: [
            {
              criteria: {valid: true},
              attributes: {color: "green", penwidth: 1},
            },
            {
              criteria: {"rules[0].severity": "error"},
              attributes: {fontcolor: "red", color: "red", penwidth: 5},
            },
            {
...
// generated: dependency-cruiser@11.10.0 on 2022-06-20T20:47:13.404Z
