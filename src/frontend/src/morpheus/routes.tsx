...
import {T09AContainer, T09BContainer, T09CContainer, T09Container, T09DContainer, T09EContainer, T09FContainer} from 'morpheus/T09/presentation/containers';
import T11Container from 'morpheus/T11/presentation/containers/T11Container';
import {T13AContainer, T13BContainer, T13CContainer, T13Container, T13DContainer, T13EContainer} from 'morpheus/T13/presentation/containers';
import {T14AContainer, T14BContainer, T14CContainer, T14Container, T14DContainer} from 'morpheus/T14/presentation/containers';
import T18Container from 'morpheus/T18/presentation/containers/T18Container';
...
import {UserListContainer} from './user/presentation/containers';
...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/news" element={wrapRouteComponent(<UserListContainer/>)}/>
