...
class River(BoundaryBase):
    ...
    def from_dict(cls, obj):
        return cls(
            ...
            observations=[RiverObservation.from_dict(p) for p in obj['observation_points']],
        )
