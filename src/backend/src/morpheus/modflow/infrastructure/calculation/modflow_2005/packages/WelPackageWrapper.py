...
def calculate_wel_package_data(modflow_model: ModflowModel) -> WelPackageData | None:
...
def create_wel_package(flopy_modflow: FlopyModflow, modflow_model: ModflowModel) -> FlopyModflowWel | None:
    package_data = calculate_wel_package_data(modflow_model)
