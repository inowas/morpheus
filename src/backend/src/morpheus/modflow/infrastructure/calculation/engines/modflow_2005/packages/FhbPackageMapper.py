...
from morpheus.modflow.types.boundaries.Boundary import BoundaryType, FlowAndHeadBoundary
from morpheus.modflow.types.boundaries.FlowAndHeadObservation import FlowDataItem, HeadDataItem, StartDateTime, \
...
def get_date_times(model: ModflowModel) -> list[StartDateTime]:
...
def get_total_times(date_times: list[StartDateTime], model: ModflowModel) -> list[float]:
    total_times = []
...
def calculate_fhb_boundary_stress_period_data(model: ModflowModel) -> FhbStressPeriodData | None:
