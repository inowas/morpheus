...
from morpheus.modflow.application.projectors.ProjectSummaryProjector import ProjectSummaryProjector, project_summary_projector
from morpheus.modflow.infrastructure.event_sourcing.ModflowEventStore import ModflowEventStore, modflow_event_store


class ReprojectProjectSummariesCliCommand:
    def __init__(
        self,
        event_store: ModflowEventStore,
