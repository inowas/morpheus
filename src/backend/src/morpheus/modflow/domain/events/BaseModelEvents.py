...
from morpheus.modflow.types.BaseModelVersion import BaseModelVersion
...
class LatestBaseModelVersionedEvent(EventBase):
    ...
    def get_event_name(self) -> EventName:
        return EventName.from_str(ModflowEventName.TAG_VERSION.to_str())
