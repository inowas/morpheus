...
from .presentation.api import read_sensor_list_with_latest_values
from .presentation.cli import ReadUITSensorDataFromCSVFilesCliCommand
...
def bootstrap(app: Flask):
    ...
    def read_sensors():
        return read_sensor_list_with_latest_values()
