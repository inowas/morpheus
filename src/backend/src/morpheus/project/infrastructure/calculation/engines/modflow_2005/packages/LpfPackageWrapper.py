...
class LpfPackageSettings:
    ...
    def __init__(
        ...
        iwetit: int = 1,
        ihdwet: int = 0,
        wetdry: float | list[float | list[list[float]]] = -0.01,
...
class LpfPackageData:
    ...
    def __init__(
        ...
        iwetit: int = 1,
        ihdwet: int = 0,
        hk: float | list[float | list[list[float]]] = 1.0,
        hani: float | list[float | list[list[float]]] = 1.0,
        vka: float | list[float | list[list[float]]] = 1.0,
        ss: float | list[float | list[list[float]]] = 1e-5,
