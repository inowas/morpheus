...
from morpheus.project.domain.events.PermissionEvents import MemberRoleUpdatedEvent
...
class UpdateProjectMemberRoleCommandHandler(CommandHandlerBase):
    ...
    def handle(command: UpdateProjectMemberRoleCommand):
        ...
        event = MemberRoleUpdatedEvent.from_user_id_and_role(project_id=project_id, user_id=member_id, new_role=new_role)
