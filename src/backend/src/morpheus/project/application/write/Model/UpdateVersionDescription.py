...
class UpdateVersionDescriptionCommandPayload(TypedDict):
    project_id: str
    version_id: str
...
class UpdateVersionDescriptionCommand(CommandBase):
    ...
    @classmethod
    def from_payload(cls, user_id: UserId, payload: UpdateVersionDescriptionCommandPayload):
        return cls(
            user_id=user_id,
...
class UpdateVersionDescriptionCommandHandler(CommandHandlerBase):
    @staticmethod
