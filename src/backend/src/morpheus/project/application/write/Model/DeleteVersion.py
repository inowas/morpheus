...
class DeleteVersionCommandPayload(TypedDict):
    project_id: str
    version_id: str
...
class DeleteVersionCommand(CommandBase):
    ...
    @classmethod
    def from_payload(cls, user_id: UserId, payload: DeleteVersionCommandPayload):
        return cls(
            user_id=user_id,
...
class DeleteVersionCommandHandler(CommandHandlerBase):
    @staticmethod
