...
class CreateVersionCommandPayload(TypedDict):
    project_id: str
    version_tag: str
...
class CreateVersionCommand(CommandBase):
    ...
    @classmethod
    def from_payload(cls, user_id: UserId, payload: CreateVersionCommandPayload):
        return cls(
            user_id=user_id,
...
class CreateVersionCommandHandler(CommandHandlerBase):
    @staticmethod
