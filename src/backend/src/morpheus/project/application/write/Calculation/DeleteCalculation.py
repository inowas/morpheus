...
class DeleteCalculationCommandHandler(CommandHandlerBase):
    ...
    def handle(command: DeleteCalculationCommand):
        ...
        assert calculation_repository.has_calculation(project_id=project_id, calculation_id=command.calculation_id)

        calculation_repository.delete_calculation(project_id=project_id, calculation_id=command.calculation_id)
