...
class TestCreateModelCommand:
    ...
    def setup_project(self, user_id, project_id, command_bus):
        ...
        command = CreateProjectCommand(
            ...
            description=Description('Test project for model tests'),
...
class TestUpdateModelTimeDiscretizationCommand:
    ...
    def test_update_time_discretization_single_steady_state_period(
        self, project_id, user_id, command_bus
    ):
    ...
    def test_update_time_discretization_multiple_transient_periods(
        self, project_id, user_id, command_bus
    ):
    ...
    def test_update_time_discretization_with_hours_unit(
        self, project_id, user_id, command_bus
    ):
