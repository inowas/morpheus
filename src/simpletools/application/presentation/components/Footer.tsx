          ...
          <Grid.Row columns={4}>
            <Grid.Column textAlign="left" style={{padding: '0em 2em'}}>
              <List link={true} inverted={true}>
                <List.Item>Release: {props.version || 'dev'}</List.Item>
                &nbsp;
                <List.Item>
                  <a
                    href="https://tu-dresden.de/bu/umwelt/hydro/inowas" target="_blank"
                ...
                <List.Item>
                  <Link
                    to={{pathname: 'https://inowas.com/imprint/'}} rel="noreferrer"
                    target="_blank"
                  >
                    Imprint
                  </Link>
            ...
            <Grid.Column>
              ...
              />
              <a
                href="https://tu-dresden.de/" target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <Grid.Column>
              ...
              />
              <a
                href="https://www.bmbf.de/en/index.html" target="_blank"
                rel="noopener noreferrer"
              >
